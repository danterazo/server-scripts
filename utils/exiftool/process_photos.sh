...
## description: preserve original filename as EXIF XMP data for photos
...
args=(
    ...
    # automatically fill "creator" fields across EXIF, XMP-DC, XMP-CC, and XMP-Photoshop namespaces
    '-Artist=Dante Razo'
    '-Creator=Dante Razo'
